...
def extract_data(table_name, query_sql, start_date, end_date):
...
# Function to run tasks on a weekly basis
def run_weekly_tasks(table_name, query_sql, start_date, end_date):
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        while current_date <= end_date:
            ...
            executor.submit(extract_data, table_name, query_sql, current_date, next_date)
...
def main():
    ...
    run_weekly_tasks(table_name, query_sql, start_date, end_date)
